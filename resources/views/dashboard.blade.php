...
<section style="padding: 3rem">
    <h6 class="p-3" style="background: #D84315; color: white">Dashboard</h6>
    <div class="section_body">
        <div class="row">
            <div class="col">
                <div class="reg_doctor p-3" style="background: #388E3C; color: white; height: 20vh;text-align: center;">
